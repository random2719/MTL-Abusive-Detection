...
from model_share_att import GatingMechanism
...
def parse_args():
    ...
    parser.add_argument('--save_model_node', type=str, default='data/save_model/best_model_node.ckpt',
                        help='Directory to save model')
    parser.add_argument('--save_model_node_eval_loss', type=str, default='data/save_model/best_model_node_eval_loss.ckpt',
                        help='Directory to save model')
...
def main():
    ...
    if args.pure_bert:
        ...
        model = GatingMechanism(args, dep_tag_vocab['len'], pos_tag_vocab['len'])
    elif args.gcn:
        print('GCN模型')
        model=GCNClassifier(args,dep_tag_vocab['len'], pos_tag_vocab['len'])
